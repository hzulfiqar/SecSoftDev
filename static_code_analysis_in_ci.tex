...
Code quality management (CQM) is the practice of monitoring and controling the quality of code with different metrics and activities.
...
\begin{description}
	\item[Is the tool easy and intuitive to configure?] \hfill \\
