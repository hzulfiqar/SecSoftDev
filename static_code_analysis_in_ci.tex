...
%
% paper title
\title{Integration of Static Code Analysis\\in Continuous Integration Lifecycles}
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.9\linewidth]{img/comparation}
	\caption{Comparison of the usability and features of the evaluated tool}
